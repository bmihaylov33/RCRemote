...
public class DeviceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isFirstRun = getSharedPreferences("com.tu_sofia.rcremote", MODE_PRIVATE);
    ...
    public void onResume() {
        ...
        if (isFirstRun.getBoolean("first_run", true)) {
            // Do first run stuff here then set 'firstrun' as false
            // using the following line to edit/commit prefs
            Intent intent = new Intent(this, IntroActivity.class);
            startActivity(intent);

            isFirstRun.edit().putBoolean("first_run", false).commit();
        }
...
//            findViewById(R.id.title_paired_devices).setVisibility(View.VISIBLE);//make title viewable
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            Intent intent = new Intent(DeviceActivity.this, BluetoothConnection.class);
